...
echo "<script type='text/javascript'> alert('Welcome to dashboard');
...
<html lang="en">
  <head>
    ...
    <title>Digital Record Management and Reservation System for St. John the Baptist Parish Church Services|| Admin Sign In Page</title>
      ...
      <div class="am-signin-box">
        <div class="row no-gutters">
          <div class="col-lg-5">
            <div>
              <h2>DRMRS</h2>
              <p>Welcome to St. John the Baptist Parish Church Digital Record Management and Reservation System for St. John the Baptist Parish Church Services</p>
...
<div class="form-group">
             ...
             <div class="form-group mg-b-20" style="padding-top: 20px"><a href="forgot-password.php">
             Reset password</a></div>
             <button type="submit" class="btn btn-block" name="login">Sign In</button>
          </div>
         </form>
        </div><!-- row -->
        <p class="tx-center tx-white-5 tx-12 mg-t-15">Digital Record Management and Reservation System for St. John the Baptist Parish Church Services @ 2023</p>
      </div><!-- signin-box -->
