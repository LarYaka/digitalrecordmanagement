...
include_once('includes/sidebar.php');
 ...
 ?>
    ...
    <div class="am-pagetitle">
      <h5 class="am-title">Confession Application</h5>
    ...
    <div class="am-mainpanel">
      <div class="am-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">All Confession Application</h6>
          ...
          <div class="table-wrapper" style="padding-top: 20px">
            <table id="datatable1" class="table display responsive nowrap">
              ...
              <tbody>
                <?php
$sql="SELECT * from tblconfession where status =''";
...
<?php } else { ?>                  <td><?php  echo htmlentities($row->Status);?>
                  ...
                  <?php } ?>
                  <td><a href="view-confession-res-detail.php?viewid=<?php echo htmlentities ($row->ID);?>"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
                </tr>
              <?php $cnt=$cnt+1;}} ?> 
              </tbody>
            </table>
...
<?php include_once('includes/footer.php');?>
    ...
    <script>
      ...
      if (currentURL.includes("all-confession-app.php")) {
