...
$sql= "update tblbaptism set Status=:status,Remark=:remark where ID=:vid";
...
include_once('includes/sidebar.php');
 ...
 ?>
    ...
    <div class="am-pagetitle">
      <h5 class="am-title">Baptism Appointment Status</h5>
...
$sql="SELECT tblbaptism.*,tbluser.FirstName,tbluser.LastName,tbluser.MobileNumber,tbluser.Address from  tblbaptism join  tbluser on tblbaptism.UserID=tbluser.ID where tblbaptism.ID=:vid";
$query = $dbh -> prepare($sql);
$query-> bindParam(':vid', $vid, PDO::PARAM_STR);
$query->execute();
...
<td colspan="9" style="font-size:20px;color:blue">
 ...
 Sponsor Details</td></tr>
  ...
  <tr>
    <td colspan="5"><?php  echo $row->GodParents2;?></td>
    <td colspan="5"><?php  echo $row->GPR2;?></td>
  </tr>
  <td colspan="8" style="font-size:20px;color:red">
  Other Details</td></tr>
...
{
 echo "Your reservatiom is invalid";
}
