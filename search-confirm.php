...
<html lang="en">
  <head>
    ...
    <title>Digital Marriage Registration System in St. John the Baptist Parish Church || Search Marriage Application</title>
    ...
    <div class="am-mainpanel">
      <div class="am-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Search Confirmation Application</h6>
            ...
            <table id="datatable1" class="table display responsive nowrap">
              <thead>
                <tr>
                  ...
                  <th class="wd-10p">Date of Appointment</th>
...
$sql="SELECT * from tblconfirm where RegistrationNumber like '$sdata%' && UserID='$uid'";
