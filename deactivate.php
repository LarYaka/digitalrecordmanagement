...
if (strlen($_SESSION['omrsaid']) == 0) {
    ...
    $sql = "UPDATE tbluser SET Status = 'Activate' WHERE ID = :id";
...
include_once('includes/sidebar.php');
 ...
 ?>
  ...
  <div class="am-pagetitle">
    <h5 class="am-title">Deactivated User Account Query</h5>
    ...
    <div class="am-mainpanel">
      <div class="am-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Deactivated User Account Query</h6>
            ...
            <table id="datatable1" class="table display responsive nowrap">
              ...
              <tbody>
               <?php
                                            ...
                                            $sql = "SELECT * from  tbluser WHERE Status='Deactivate'";
                                            $query = $dbh->prepare($sql);
                                            $query->execute();
                ...
                <tr>
                  ...
                  <a href="deactivate.php?id=<?php echo htmlentities($row->ID); ?>" class="btn btn-primary">activate</a>
          </td> 
        </tr>
                </tr>
                <?php $cnt=$cnt+1;}} 
