...
include_once('includes/sidebar.php');
 ...
 ?>
    ...
    <div class="am-pagetitle">
      <h5 class="am-title">New Wedding Reservation Application</h5>
    ...
    <div class="am-mainpanel">
      <div class="am-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">New Wedding Reservation Application</h6>
...
{               ?>
                <tr>
                  ...
                  <td><?php  echo htmlentities($row->GroomName);?></td>
