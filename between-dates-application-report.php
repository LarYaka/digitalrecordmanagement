...
?>
  ...
  <head>
    ...
    <title>Digital Marriage Registration System in St. John the Baptist Parish Church !! Between Dates Report</title>
          ...
          <div class="col-xl-12">
            <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
              ...
              <form id="basic-form" method="post" action="application-bwdates-reports-details.php">
                ...
                <div class="row mg-t-20">
                  <label class="col-sm-4 form-control-label">Reservation: <span class="tx-danger">*</span></label>
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <select class="form-select form-control" name="reservation" required='true' aria-label="Default select example">
                      <option selected>Open this select reservation</option>
                      <option value="Wedding">Wedding</option>
                      <option value="Anointing">Anointing</option>
                      <option value="Baptism">Baptism</option>
                      <option value="Columnbarium">Columnbarium</option>
