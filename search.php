...
<html lang="en">
  <head>
    ...
    <title>Digital Record Management and Reservation System for St. John the Baptist Parish Church || Search Reservation Application</title>
...
include_once('includes/sidebar.php');
 ...
 ?>
    ...
    <div class="am-pagetitle">
      <h5 class="am-title">Search Reservation Application</h5>
    ...
    <div class="am-mainpanel">
      <div class="am-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Search Reservation Application</h6>
