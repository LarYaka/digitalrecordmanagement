...
$sql= "update tblfuneral set Status=:status,Remark=:remark where ID=:vid";
...
include_once('includes/sidebar.php');
 ...
 ?>
    ...
    <div class="am-pagetitle">
      <h5 class="am-title">Funeral Blessing Appointment Status</h5>
...
$sql="SELECT tblfuneral.*,tbluser.FirstName,tbluser.LastName,tbluser.MobileNumber,tbluser.Address from  tblfuneral join  tbluser on tblfuneral.UserID=tbluser.ID where tblfuneral.ID=:vid";
$query = $dbh -> prepare($sql);
$query-> bindParam(':vid', $vid, PDO::PARAM_STR);
$query->execute();
...
<td colspan="9" style="font-size:20px;color:blue">
 ...
 <tr>
  <th colspan="5">Date of Interment:</th>
  <td colspan="5"><?php echo $row->Doi;?></td>
 </tr>

  <tr>
  <td colspan="8" style="font-size:20px;color:red">
  Deceased Details</td></tr>
   <tr>
    <th colspan="5">Fullaname</th>
    <td colspan="5"><?php echo $row->Fullname;?></td>
  </tr>
  <td colspan="8" style="font-size:20px;color:red">
  Immediate Family Details</td></tr>
