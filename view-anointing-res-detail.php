...
$sql= "update tblanointing set Status=:status,Remark=:remark where ID=:vid";
...
$query->bindParam(':vid',$vid,PDO::PARAM_STR);
 ...
 echo "<script>window.location.href ='all-anointing-app.php'</script>";
}
...
include_once('includes/sidebar.php');
 ...
 ?>
    ...
    <div class="am-pagetitle">
      <h5 class="am-title">Anointing of the Sick Appointment Status</h5>
...
$sql="SELECT tblanointing.*,tbluser.FirstName,tbluser.LastName,tbluser.MobileNumber,tbluser.Address from  tblanointing join  tbluser on tblanointing.UserID=tbluser.ID where tblanointing.ID=:vid";
$query = $dbh -> prepare($sql);
$query-> bindParam(':vid', $vid, PDO::PARAM_STR);
$query->execute();
...
<td colspan="9" style="font-size:20px;color:blue">
 ...
 <tr>
  <td colspan="8" style="font-size:20px;color:red">
  Sick Person Details</td></tr>
  <tr>
    <th colspan="5">Fullname</th>
    <td colspan="5"><?php echo $row->Fullname;?></td>
  </tr>
  <tr>
    <th colspan="5">Disease</th>
    <td colspan="5"><?php echo $row->Disease;?></td>
  </tr>
  <tr>
  <tr>
