...
<html lang="en">
  <head>
    ...
    <title>Digital Marriage Registration System in St. John the Baptist Church || Deactivated Marriage Application</title>
...
include_once('includes/sidebar.php');
 ...
 ?>
  ...
  <div class="am-pagetitle">
    <h5 class="am-title">Deactivated Services Reservation Query</h5>
        ...
        <div class="card pd-20 pd-sm-40">
          ...
          <div class="table-wrapper" style="padding-top: 20px">
            <table id="datatable1" class="table display responsive nowrap">
              ...
              <tbody>
                <?php
                  $sql="SELECT FirstName, LastName, EmailAdd, Status FROM tbluser WHERE Status='Deactivate'";
